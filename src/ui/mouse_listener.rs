...
) -> MouseListener<'a, Message, Renderer>
where
    Renderer: iced_native::Renderer,
{
    MouseListener::new(widget)
}
...
impl<'a, Message, Renderer> Widget<Message, Renderer> for MouseListener<'a, Message, Renderer>
where
    Renderer: iced_native::Renderer,
    Message: Clone,
{
...
{
    fn from(listener: MouseListener<'a, Message, Renderer>) -> Element<'a, Message, Renderer> {
